...
import joao.tcc.ms.app.repository.ItemRepository;
import joao.tcc.ms.app.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link joao.tcc.ms.app.domain.Item}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ItemResource {
    ...
    private static final String ENTITY_NAME = "itemcrudItem";
