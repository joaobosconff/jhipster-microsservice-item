package joao.tcc.item.app.web.rest;
...
import joao.tcc.item.app.repository.ItemRepository;
import joao.tcc.item.app.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link joao.tcc.item.app.domain.Item}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ItemResource {
    ...
    private static final String ENTITY_NAME = "itemsappItem";
